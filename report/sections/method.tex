...
The evaluation compares the adaptive looped model against a direct GRU-based baseline and a fixed-depth version of the same looped architecture. These comparisons isolate the value of recurrence and the value of adaptive early exit separately while keeping the encoder and hidden size controlled.
